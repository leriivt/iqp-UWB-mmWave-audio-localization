...
from PyQt5.QtGui import QColor, QPalette, QFont, QPainter, QBrush, QPen, QLinearGradient
...
class View2D(pg.PlotWidget):
    def __init__(self, parent=None):
        ...
        ring.setPen(pg.mkPen(PALETTE['border'], style=Qt.DashLine))
...
class mmWaveVisualizer(QMainWindow):
    def __init__(self):
        ...
        self.source = MockDataGenerator(fps=10.0) #mock data generator for testing without hardware
        self.source.frame_ready.connect(self._on_frame) #callback for mock data generator
        ...
        #self.source.start() #uncomment to activte mock data generator
