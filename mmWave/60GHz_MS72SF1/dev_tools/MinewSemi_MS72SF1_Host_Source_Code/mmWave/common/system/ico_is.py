...
def get_ico():
    Create_file_patch_ico_logo = Create_file_from_data(common.img.MINEWSEMI_logo_ico_32.MINEWSEMI_logo_ico_32, '.ico')

    return Create_file_patch_ico_logo


def get_logo_img():
    Create_file_patch_logo = Create_file_from_data(common.img.MINEWSEMI_logo_300.MINEWSEMI_logo_300, '.png')

    return Create_file_patch_logo


def get_product_img():
    Create_file_patch_product = Create_file_from_data(common.img.MINEWSEMI_product_300.MINEWSEMI_product_300, '.png')

    return Create_file_patch_product


def get_mmWave_map():
    Create_file_patch_mmWave_map = '"' + Create_file_from_data(common.img.mmWave_map.data, '.png') + '"'

    return Create_file_patch_mmWave_map


import common.img.MINEWSEMI_logo_ico_32
import common.img.MINEWSEMI_logo_300
import common.img.MINEWSEMI_product_300
